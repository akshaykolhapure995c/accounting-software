Public Class pos
    ...
    Dim i As Integer
    Private Sub pos_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Main.Enabled = True
    End Sub
    ...
    Private Sub pos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        cmd.Open("Select name from pos", con, ADODB.CursorTypeEnum.adOpenDynamic, ADODB.LockTypeEnum.adLockOptimistic)
        While Not cmd.EOF
            i = 0
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        cmd.Open("select * from pos  where da_te  >= '" & DateTimePicker2.Value.Date & "' and da_te<= '" & DateTimePicker3.Value.Date & "'", con, ADODB.CursorTypeEnum.adOpenDynamic, ADODB.LockTypeEnum.adLockOptimistic)
        i = 0
        While Not cmd.EOF
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Else
            cmd.Open("Select * from pos", con, ADODB.CursorTypeEnum.adOpenDynamic, ADODB.LockTypeEnum.adLockOptimistic)
            cmd.AddNew()
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        Else
            DataGridView1.Rows.Clear()
            cmd.Open("select * from pos where da_te  >= '" & DateTimePicker2.Value.Date & "' and da_te<= '" & DateTimePicker3.Value.Date & "' and name='" & ComboBox1.Text & "'", con, ADODB.CursorTypeEnum.adOpenDynamic, ADODB.LockTypeEnum.adLockOptimistic)
            i = 0
            While Not cmd.EOF
                i = i + cmd.Fields("amount").Value
                DataGridView1.Rows.Add(cmd.Fields("da_te").Value, cmd.Fields("name").Value, cmd.Fields("amount").Value)
